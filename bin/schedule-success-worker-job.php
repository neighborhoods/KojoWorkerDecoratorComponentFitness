...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\SuccessWorker;
...
$connection->insert(
    'kojo_job',
    [
        'type_code' => SuccessWorker\WorkerInterface::JOB_TYPE_CODE,
        'name' => 'Worker completing successfully',
        'priority' => 10,
        'importance' => 10,
        ...
        'previous_state' => 'new',
        'worker_uri' => SuccessWorker\Worker\Proxy::class,
        'worker_method' => 'work',
