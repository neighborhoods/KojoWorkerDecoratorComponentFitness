...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\FailingWorker;
...
$connection->insert(
    'kojo_job',
    [
        'type_code' => FailingWorker\WorkerInterface::JOB_TYPE_CODE,
        'name' => 'Worker failing due to non-transient fault',
        'priority' => 10,
        'importance' => 10,
        ...
        'previous_state' => 'new',
        'worker_uri' => FailingWorker\Worker\Proxy::class,
        'worker_method' => 'work',
