...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\NamedWorker;
...
$connection->insert(
    'kojo_job',
    [
        'type_code' => NamedWorker\CustomWorkerNameInterface::JOB_TYPE_CODE,
        'name' => 'Worker not named worker',
        'priority' => 10,
        'importance' => 10,
        ...
        'previous_state' => 'new',
        'worker_uri' => NamedWorker\CustomWorkerName\Proxy::class,
        'worker_method' => 'work',
