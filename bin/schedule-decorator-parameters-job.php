...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\DecoratorParameters;
...
$connection->insert(
    'kojo_job',
    [
        'type_code' => DecoratorParameters\WorkerInterface::JOB_TYPE_CODE,
        'name' => 'Worker setting custom parameter values for predefined decorators',
        'priority' => 10,
        'importance' => 10,
        ...
        'previous_state' => 'new',
        'worker_uri' => DecoratorParameters\Worker\Proxy::class,
        'worker_method' => 'work',
