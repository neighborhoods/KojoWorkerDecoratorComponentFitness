...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\DecoratorParameters as Component;
use Symfony\Component\Finder\Finder;
use Phinx\Migration\AbstractMigration;

final class CreateDecoratorParametersJobType  extends AbstractMigration
{
    public function up()
    {
        ...
        $jobCreator->setCode(Component\WorkerInterface::JOB_TYPE_CODE)
            ...
            ->setName('Worker setting custom parameter values for predefined decorators')
            //  ->setCronExpression('* * * * *')
