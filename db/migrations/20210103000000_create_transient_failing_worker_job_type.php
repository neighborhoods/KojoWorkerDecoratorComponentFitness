...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\TransientFailingWorker as Component;
use Symfony\Component\Finder\Finder;
use Phinx\Migration\AbstractMigration;

final class CreateTransientFailingWorkerJobType  extends AbstractMigration
{
    public function up()
    {
        ...
        $jobCreator->setCode(Component\WorkerInterface::JOB_TYPE_CODE)
            ...
            ->setName('Worker failing due to transient fault')
            //  ->setCronExpression('* * * * *')
