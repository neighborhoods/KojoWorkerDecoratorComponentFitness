...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\ReschedulingDecorator as Component;
use Symfony\Component\Finder\Finder;
use Phinx\Migration\AbstractMigration;

final class CreateReschedulingDecoratorJobType extends AbstractMigration
{
    public function up()
    {
        ...
        $jobCreator->setCode(Component\WorkerInterface::JOB_TYPE_CODE)
            ...
            ->setName('Worker being rescheduled by Rescheduling Decorator')
            //  ->setCronExpression('* * * * *')
