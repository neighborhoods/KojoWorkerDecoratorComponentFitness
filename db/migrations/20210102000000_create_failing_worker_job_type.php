...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\FailingWorker as Component;
use Symfony\Component\Finder\Finder;
use Phinx\Migration\AbstractMigration;

final class CreateFailingWorkerJobType  extends AbstractMigration
{
    public function up()
    {
        ...
        $jobCreator->setCode(Component\WorkerInterface::JOB_TYPE_CODE)
            ...
            ->setName('Worker failing due to non-transient fault')
            //  ->setCronExpression('* * * * *')
