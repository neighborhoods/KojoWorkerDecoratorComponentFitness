...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\CustomDecorator as Component;
use Symfony\Component\Finder\Finder;
use Phinx\Migration\AbstractMigration;

final class CreateCustomDecoratorJobType  extends AbstractMigration
{
    public function up()
    {
        ...
        $jobCreator->setCode(Component\WorkerInterface::JOB_TYPE_CODE)
            ...
            ->setName('Worker with custom Kojo Worker Decorator')
            //  ->setCronExpression('* * * * *')
