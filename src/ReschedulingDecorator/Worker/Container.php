...
namespace Neighborhoods\KojoWorkerDecoratorComponentFitness\ReschedulingDecorator\Worker;
...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\ReschedulingDecorator\Worker as Worker;
...
final class Container implements ContainerInterface
{
    private const KOJO_WORKER_DECORATORS = [
        ...
        'WorkerV1Decorators/ReschedulingV1',
    ...
    private function buildWrappedContainer(): PsrContainerInterface
    {
        ...
        $containerBuilder = (new TinyContainerBuilder())
            ...
            ->addSourcePath('buphalo-fab/ReschedulingDecorator')
            ->addSourcePath('src/ReschedulingDecorator')
    ...
    public function getReschedulingDecoratorWorkerBuilderFactory(): Builder\FactoryInterface
    {
