...
namespace Neighborhoods\KojoWorkerDecoratorComponentFitness\FailingWorker\Worker;
...
use Neighborhoods\KojoWorkerDecoratorComponentFitness\FailingWorker\Worker as Worker;
...
final class Container implements ContainerInterface
{
    ...
    private function buildWrappedContainer(): PsrContainerInterface
    {
        ...
        $containerBuilder = (new TinyContainerBuilder())
            ...
            ->addSourcePath('buphalo-fab/FailingWorker')
            ->addSourcePath('src/FailingWorker')
    ...
    public function getFailingWorkerWorkerBuilderFactory(): Builder\FactoryInterface
    {
